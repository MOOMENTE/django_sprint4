# Generated by Django 3.2.16 on 2025-09-19 04:43
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(help_text='Используется в адресе страницы. Разрешены буквы латиницы, цифры, дефис и подчёркивание.', unique=True, verbose_name='Идентификатор')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pub_date', models.DateTimeField(default=django.utils.timezone.now, help_text='Если указать дату в будущем, получится отложенный пост.', verbose_name='Дата и время публикации')),
                ('image', models.ImageField(blank=True, upload_to='posts/', verbose_name='Изображение')),
                ('is_published', models.BooleanField(default=True, help_text='Снимите галочку, чтобы скрыть пост.', verbose_name='Опубликовано')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Добавлено')),
